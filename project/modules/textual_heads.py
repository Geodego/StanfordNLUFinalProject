...
class TransformerTextualHead(TextualHead):
    ...
    def __init__(
        ...
        self.visual_projection = nn.Linear(visual_feature_size, self.textual_feature_size)
...
class TransformerDecoder(TransformerTextualHead):
    """
    Allow pretrained embedding and freezing embeddings
    embedding: used when initial embedding of words in vocabulary is given.
