...
if __name__ == '__main__':
    ...
    output = task.train_and_save_agent(hyper_id=4, training_data_id=6, save_memory=False)
    ...
    colors_dev_reduced = colors_dev[:1500]
    seqs_beam = model.predict_beam_search(colors_dev_reduced)
